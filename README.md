...
|---|---|---|---|
| **Ubuntu 24.04** | `linux-desktop-novnc-pulseaudio-ubuntu-kde` | _dropped — GNOME only on Fedora_ | `linux-desktop-novnc-pulseaudio-ubuntu-xfce` |
...
| _ubuntu-gnome (dropped — GNOME only on Fedora)_ | — |
